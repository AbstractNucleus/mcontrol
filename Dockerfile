...
# Docker CLI + compose v2 plugin, used by infra/compose.py for
# `docker compose up` (start / recreate).
...
CMD ["/app/.venv/bin/uvicorn", "mcontrol.main:app", "--host", "0.0.0.0", "--port", "8000"]
